...
def main(open_plot=True):
    gamma, N_apples, N_tagged = [0.99, 0, 5]
    possible_apple_locations = [(17,4), (16,5), (17,5), (18,5), (15,6), (16,6), (17,6), (18,6), (19,6), (16,7), (17,7), (18,7), (17,8)]
    gathering = GatheringMDP(gamma, possible_apple_locations, N_apples, N_tagged, render=True)
    ...
    # dqn = DQNAgent(gathering.get_actions(), x_dim=35, y_dim=13, num_channels=3, should_train=False, from_checkpoint='/tmp/dqn-deep-mind.ckpt', eps_start=0.1, eps_end = 0.1)
    ...
    play_markov_game([fixed_agent2, fixed_agent], gathering, instances=1, episodes=10, steps=1000, open_plot=open_plot)
